...
class PlotWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.layout.addWidget(self.remarks_label,1,0)
        self.layout.addWidget(self.remark_textbox,2,0)
        self.layout.addWidget(self.days_label,1,1)
        self.layout.addWidget(self.days_textbox,2,1)
        self.layout.addWidget(self.button,3,1)  
        self.layout.addWidget(self.export_button,4,1)
