...
from label_arrow import round_tenths
class dragged():
    ...
    def on_release_event(self, event):
        ...
        if self.dragged is not None :
            ...
            if self.arr_drag_dict[self.key] is not False:
                ...
                # annot = self.dragged.axes.annotate(text = self.text, xy = annot_origin, xytext = new_pos, arrowprops={"width":0.1}, rotation= "vertical")
